import { GameState, RoundTime, Player } from '@paint-and-guess/lib/models';
...
export class Game {
    ...
    public calculateScoreToAdd(): number {
        const scoreToAdd =
    ...
    public getDrawingPlayer() {
        return this.players.get(this.drawingPlayerId)!;
    }

    public increasePlayerScore(id: string): {
